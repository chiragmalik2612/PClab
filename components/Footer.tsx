  ...
  return (
    <footer className="bg-slate-900 text-slate-400 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm leading-relaxed mb-8 text-slate-400 md:pr-10">
              {contact.labName}. Advancing the intersection of tissue-engineered scaffolds and cognitive hardware-software interfaces.
            </p>
            <div className="flex space-x-4">
              {/* Twitter Icon */}
              {/* <a href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#009966] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li><Link href="/people" className="hover:text-white transition-colors">People & Leadership</Link></li>
        ...
        <div className="pt-8 border-t border-slate-800 flex items-center text-xs font-medium text-slate-500">
